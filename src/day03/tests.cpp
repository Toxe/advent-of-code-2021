...
TEST_CASE("part 2")
{
    SECTION("works with example input")
    {
        ...
        CHECK(day03_part2(numbers, 5) == 230);
    }

    SECTION("returns 0 if there are no numbers")
    {
        CHECK(day03_part2({}, 12) == 0);
    }
    ...
    SECTION("returns 0 if width is invalid")
    {
        ...
        CHECK(day03_part2(numbers, 0) == 0);
        CHECK(day03_part2(numbers, std::numeric_limits<unsigned int>::digits + 1) == 0);
    }
}
